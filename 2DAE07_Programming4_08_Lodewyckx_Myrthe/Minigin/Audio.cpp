...
#include <thread>
#include <mutex>
null_sound_system ServiceLocator::default_instance;
sound_system* ServiceLocator::ss_instance = &default_instance;

AudioClip clips[]
{
	{int(PLAYER_DIES),"../Data/SoundEffects/LoseLife.wav"},
